    ...
    <div class="right-main">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="nav">
                        <div class="titleShow"><h1>请选择${section.sSectionname}版面需要加精的主贴</h1></div>
                        <!--显示选择看帖子还是精华帖-->
                        <div class="selects">
                            <div class="row">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <button class="btn btn-danger" id="selectPerfect"><span class="glyphicon glyphicon-plus" aria-hidden="true">加精</span></button>
                </div>
            </div>
...
<script>
    ...
    function to_page(pn){
        ...
        $.ajax({
            url:"${APP_PATH}/main/findNotPerfect",
            data:data,
            type:"get",
    ...
    //点击加精就批量加精
    $("#selectPerfect").click(function () {
        if("${userid}".length===0){
            alert("您当前未登录，不能为帖子加精！");
            return;
        }
